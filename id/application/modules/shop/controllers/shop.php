...
class Shop extends CI_Controller {
 public $username;
	...
	function product($offside=0){
		$data['title']='Product';
		$data['meta']=$this->m->select_meta('products',array('idproduct'=>20));
		...
		function product_category(){
		 	$data['product_category']=$this->m->select_product_categories();
	...
	function services(){
		...
		function not_available(){
			$this->view('not_available');
		}
	
	function promotions(){
		$data['title']='Kupon Promosi';
		//$data['meta']=$this->m->select_meta('products',array('idproduct'=>20));
